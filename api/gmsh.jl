...
# This file defines the Gmsh Julia API (v4.12.2).
#
...
const GMSH_API_VERSION = "4.12.2"
const GMSH_API_VERSION_MAJOR = 4
const GMSH_API_VERSION_MINOR = 12
const GMSH_API_VERSION_PATCH = 2
const libdir = dirname(@__FILE__)
const libname = Sys.iswindows() ? "gmsh-4.12.dll" : "libgmsh"
import Libdl
