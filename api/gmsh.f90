...
!
! This file defines the Gmsh Fortran API (v4.12.2).
!
...
module gmsh
  ...
  integer, parameter, public :: GMSH_API_VERSION_MINOR = 12
  integer, parameter, public :: GMSH_API_VERSION_PATCH = 2
  integer, parameter, public :: GMSH_API_MAX_STR_LEN = 512
  real(c_double), parameter, public :: M_PI = 3.14159265358979323846_c_double
  character(len=100), parameter, public :: GMSH_API_VERSION = "4.12.2"
